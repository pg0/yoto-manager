...
function PaneHead() {
  ...
  return (
    ...
    <div className="pane-head">
      ...
      <label className="opt" title="Repeat the card from the first track when the last one ends">
        <input
          type="checkbox"
          checked={card.settings.loop}
          onChange={(e) => setSetting('loop', e.target.checked)}
        />
        Loop
      </label>
